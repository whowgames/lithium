...
class RequestToken {
	 ...
	 *
	 * @see lithium\util\StringDeprecated::hash()
	 ...
	 *                custom salt value to be used by `StringDeprecated::hash()`.
	 *              - `'type'` _string_: The hashing algorithm used by `StringDeprecated::hash()` when
